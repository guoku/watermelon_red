...
public class BitmapHelp {
	...
	// return bitmapUtils;
	// }
	// private static BitmapUtils getBitMapUtils (BitmapUtils
	// bitmapUtils,Context context) {
	// if (bitmapUtils == null) {
	// bitmapUtils = new BitmapUtils(context, getCachePath(Constant.CACHE_PATH,
	// context));
	 ...
	 * @return
	 */
	public static BitmapDisplayConfig getDisplayConifg(Context context,
			int defaultImg) {
		...
		config.setLoadFailedDrawable(context.getResources().getDrawable(
				defaultImg));
		config.setLoadingDrawable(context.getResources()
				.getDrawable(defaultImg));
		return config;
	}
}
