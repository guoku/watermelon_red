...
public class CustomDialog extends Dialog {
	...
	public CustomDialog(Context context) {
		...
		mProgressBar = (ProgressBar) this.findViewById(R.id.progressbar_show);
	...
	public void showProgressbar(boolean isshow){
		if(isshow){
			...
			this.findViewById(R.id.progressbar_show_layoyt).setVisibility(View.VISIBLE);
		}else{
			mProgressBar.setVisibility(View.GONE);
			this.findViewById(R.id.progressbar_show_layoyt).setVisibility(View.GONE);
		}
	}
