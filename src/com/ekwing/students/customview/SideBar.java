...
public class SideBar extends View {
	...
	private void init() {
		// 去掉了 :I/O/U/V
		letter = new String[] { "A", "B", "C", "D", "E", "F", "G", "H", "I",
	...
	protected void onDraw(Canvas canvas) {
		...
		} else if (this.mScreenWidth > 320 && this.mScreenWidth <= 640
				&& this.mScreenHeight <= 960 && this.mScreenHeight > 480) {
		...
		for (int i = 0; i < letter.length; i++) {
			...
			float yPos = (getHeight() / letter.length) * i
					+ (getHeight() / letter.length);
