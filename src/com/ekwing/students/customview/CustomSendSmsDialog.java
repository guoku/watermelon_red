...
public class CustomSendSmsDialog extends Dialog {
	...
	public void setLeftBtnListener(String text, final DialogListener listener) {
		...
		cancle.setOnClickListener(new View.OnClickListener() {
			...
			public void onClick(View arg0) {
				if (listener != null) {
					listener.doClickButton(okBtn, 0, edit,
							CustomSendSmsDialog.this);
				}
	...
	public void setRightBtnListener(String text, final DialogListener listener) {
		...
		okBtn.setOnClickListener(new View.OnClickListener() {
			...
			public void onClick(View arg0) {
				if (listener != null) {
					listener.doClickButton(okBtn, btnStatus, edit,
							CustomSendSmsDialog.this);
				}
				if (btnStatus == 1) {
					waitTimer = new WaitTimer(60);
	...
	public interface DialogListener {
		public void doClickButton(Button btn, int btnStatus, EditText edit,
				CustomSendSmsDialog dialog);
	}
}
