...
//    setCacheColorHint(context.getResources().getColor(R.color.base_write_more));
...
//
//        
//        Logger.i("TAG", "ACTION_DOWN——startY ==  " + startY);
//        
//        break;
//
...
//
//      lvHeaderTipsTv.setTextSize(16);
//      lvHeaderTipsTv.setTextColor(getResources().getColor(R.color.calor_text));
//      break;
