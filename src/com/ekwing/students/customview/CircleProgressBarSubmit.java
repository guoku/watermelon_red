...
public class CircleProgressBarSubmit extends View {
	...
	public CircleProgressBarSubmit(Context context) {
		super(context);
		oval = new RectF();
		paint = new Paint();
	}

	public CircleProgressBarSubmit(Context context, AttributeSet attrs) {
		super(context, attrs);
		// 自动生成的构造函数存根
		oval = new RectF();
		paint = new Paint();
