...
public class CustomGallery extends Gallery {
	...
	protected boolean getChildStaticTransformation(View child, Transformation t) {
		...
		transformationItem((View) child, rotateAngle, t);
		return true;
	}
	 ...
	 * @param t
	 */
	private void transformationItem(View iv, int rotateAngle, Transformation t) {
		camera.save(); // 保存摄像机之前的状态
		camera.translate(0, 0, 100f);
		int absRotateAngle = Math.abs(rotateAngle); // 取得旋转角度的绝对值

		/**
		 * 放大图片 中间的图片的zoom值为: -250 45 * 1.5 = 70 - 250 = -180 50 * 1.5 = 75 -
		 * 250 = -175
		 */
		...
		/**
		 * 设置图片的透明度 setAlpha 的取值范围: 1 ~ 255 1 完全透明 255 完全显示
		 * 
		 * 中间的图片: 255 - 0 * 2.5 = 255 两边的图片: 255 - 50 * 2.5 = 130
		 */
